...
foreach(range(1, 20) as $id)
{
	...
	$db->query("INSERT INTO posts (id, title, id_user, type, chapo, content, picture, create_date) VALUES('" . $id . "','{$faker->sentence(6)}','{$faker->numberBetween(1, 5)}','{$faker->randomElement($array=array('type1','type2','type3'))}','{$faker->sentence(15)}','$body','POST_IMG_{$faker->randomDigit()}','{$faker->date()}')") ;
}
